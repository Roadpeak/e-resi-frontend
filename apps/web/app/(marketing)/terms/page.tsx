...
export default function TermsPage() {
  return (
    ...
    >
      ...
      <Section title="2. What e-resi is">
        <p>
      ...
      <Section title="4. Developer obligations">
        <p>
        ...
        <p>
          ...
          availability shown on your listings. Listings that are misleading may be removed.
        </p>
      </Section>

      <Section title="5. Production services">
        <p>
