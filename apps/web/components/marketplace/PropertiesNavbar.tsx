 ...
 *
 * The section links live in MarketplaceNavLinks, shared with the rent navbar.
 * They use usePathname() only — no useSearchParams() — so this component no
 * longer needs the Suspense boundary it previously required to prerender.
 */
